...
import { Code, Database, Globe, Smartphone, Server, Palette, GraduationCap, Briefcase, MapPin, Cpu, Calendar, Rocket, GitBranch, Trophy } from 'lucide-react';
...
const skills = [
  ...
  },
  {
    category: 'Tools',
    icon: Code,
    technologies: ['Git', 'GitHub', 'Digital Ocean', 'Vercel', 'Figma', 'VS Code'],
  },
  {
    category: 'Design',
    icon: Palette,
...
const iconCloudSlugs = [
  ...
  "vercel", "digitalocean", "nginx", "git", "github",
  ...
  return (
    <section id="about" className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          Full-stack developer who turns complex problems into clean, seamless and scalable products — from architecture to deployment.
        </motion.p>
        ...
        >
          {stats.map((stat, i) => (
            ...
            >
              <div className="p-6 sm:p-8 rounded-2xl border border-neutral-200/80 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/40 text-center hover:border-neutral-300 dark:hover:border-neutral-700 transition-all duration-300 hover:shadow-lg dark:hover:shadow-[0_4px_24px_rgba(255,255,255,0.03)]">
                <stat.icon className="w-5 h-5 text-neutral-400 dark:text-neutral-500 mx-auto mb-3" />
                <div className="text-3xl sm:text-4xl font-bold tracking-tight mb-1">{stat.number}</div>
                <div className="text-xs sm:text-sm font-medium text-neutral-500 dark:text-neutral-400 leading-tight">{stat.label}</div>
              </div>
            </motion.div>
          ))}
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-28">
          ...
          >
            <div className="h-full p-8 sm:p-10 rounded-2xl border border-neutral-200/80 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/40 hover:border-neutral-300 dark:hover:border-neutral-700 transition-all duration-300">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-2 h-2 rounded-full bg-neutral-800 dark:bg-neutral-200"></div>
                <span className="text-xs font-semibold tracking-widest uppercase text-neutral-400 dark:text-neutral-500">My Story</span>
              </div>
              ...
              <h3 className="text-2xl sm:text-3xl font-bold leading-snug mb-6">
                ...
                <span className="text-neutral-500 dark:text-neutral-400"> first pixel </span> 
                to 
                <span className="text-neutral-500 dark:text-neutral-400"> production deploy</span>.
              </h3>

              <div className="space-y-4 text-base sm:text-lg text-neutral-600 dark:text-neutral-300 leading-relaxed">
                <p>
                  Currently a final-year <strong className="font-semibold text-neutral-900 dark:text-neutral-50">B.Tech student in Information Technology</strong>, I have spent the last two years deep in real-world product development — not just coursework.
                </p>
                <p>
                  My daily stack revolves around <strong className="font-semibold text-neutral-900 dark:text-neutral-50">React, Next.js, Node.js, Express, and PostgreSQL</strong>. I architect multi-role platforms, design stateless authentication systems, and ship features that real users depend on.
                </p>
                <p>
                  On the DevOps side, I work with <strong className="font-semibold text-neutral-900 dark:text-neutral-50">Digital Ocean, GitHub Actions CI/CD</strong>, and deploy to <strong className="font-semibold text-neutral-900 dark:text-neutral-50">AWS & Vercel</strong> — because code that doesn&apos;t ship doesn&apos;t count.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="h-full p-8 sm:p-10 rounded-2xl border border-neutral-200/80 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/40 hover:border-neutral-300 dark:hover:border-neutral-700 transition-all duration-300">
              <div className="flex items-center gap-3 mb-8">
                <div className="w-2 h-2 rounded-full bg-neutral-800 dark:bg-neutral-200"></div>
                <span className="text-xs font-semibold tracking-widest uppercase text-neutral-400 dark:text-neutral-500">Quick Profile</span>
              </div>
        ...
        >
          ...
          <p className="text-base sm:text-lg text-neutral-500 dark:text-neutral-400 max-w-2xl mx-auto">
            The modern stack I use to build, deploy, and scale production-ready applications.
          </p>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row gap-10 max-w-7xl mx-auto items-stretch">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {skills.map((skill, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <Card className="h-full border border-neutral-200/80 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/40 hover:border-neutral-300 dark:hover:border-neutral-700 hover:shadow-lg dark:hover:shadow-[0_4px_24px_rgba(255,255,255,0.03)] transition-all duration-300 hover:scale-[1.02]">
                    <CardContent className="p-5 sm:p-6">
                      <div className="flex items-center mb-4">
                        ...
                        <h4 className="font-bold text-base sm:text-lg">{skill.category}</h4>
                      </div>
          ...
          >
            <div className="w-full max-w-[400px] sm:max-w-[540px] lg:max-w-[640px] aspect-square">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                svgPath: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
